    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster', models.ImageField(default='', upload_to='poster/hindi/cinema/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster', models.ImageField(default='', upload_to='poster/hindi/webseries/')),
                ('quality', models.CharField(default='HD 1080', max_length=20)),
                ('spclnks', models.CharField(blank=True, default='#', max_length=40)),
                ('price', models.CharField(default='Free', max_length=20)),
                ('timeStamp', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AlterField(
            model_name='hindi',
            name='poster',
            field=models.ImageField(default='', upload_to='poster/hindi/all'),
        ),
    ]
